        ...
        <form wire:submit="register">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-text-input wire:model="first_name" id="first_name" class="block w-full mt-1" type="text" name="first_name" required autofocus autocomplete="given-name" />
                ...
                <div>
                    ...
                    <x-text-input wire:model="last_name" id="last_name" class="block w-full mt-1" type="text" name="last_name" required autocomplete="family-name" />
