            ...
            <div class="flex gap-2 items-center">
                <div class="p-4 bg-primary-100 dark:bg-primary-500/10">
                    <div class="flex gap-2 items-center rounded-md">
                        <img src="{{ Auth::user()->image_url }}" class="object-cover rounded-md size-20 md:size-28" alt="avatar">
                    </div>
                </div>

                <div>
                    <h1 class="font-bold md:text-2xl text-neutral-900 dark:text-neutral-100">
