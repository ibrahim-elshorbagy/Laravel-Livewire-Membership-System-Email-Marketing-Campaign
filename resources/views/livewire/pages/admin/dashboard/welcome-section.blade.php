    ...
    <div
        ...
        <div class="relative">
            <div class="flex flex-col items-center justify-between md:space-x-4 md:flex-row">
                ...
                <div class=" md:mx-0 md:mb-0">
                    <div
                        ...
                        <div class="relative p-3 lg:p-6">
                            <div class="flex flex-col items-center justify-between gap-6 md:gap-8 lg:gap-12 md:flex-row">
                ...
                @else
                @role('user')
                <div class="p-4 text-blue-800 border border-blue-200 rounded-lg bg-blue-50 dark:bg-blue-900/10 dark:border-blue-300/10 dark:text-blue-300">
                    <div class="flex items-center gap-2">
                        <i class="text-blue-500 fas fa-info-circle size-4 dark:text-blue-300"></i>
                        <span class="text-sm font-medium md:text-lg">You have not subscribed to any plan!</span>
                    </div>

                    <p class="mt-2 mb-3 text-xs md:text-sm">
                        You are currently not subscribed to any plan,<br> Please subscribe to a suitable plan to enjoy all features.
                    </p>

                    <x-primary-info-link href="{{ route('user.emails.index') }}" wire:navigate>
                        <div class="flex items-center gap-2">
                            <i class="fas fa-crown size-4 me-2"></i>
                            Choose a suitable plan to subscribe
                        </div>
                    </x-primary-info-link>
                </div>
                @endrole
