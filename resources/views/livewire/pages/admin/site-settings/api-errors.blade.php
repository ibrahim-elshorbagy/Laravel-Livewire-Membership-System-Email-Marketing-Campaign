    ...
    <header class="flex flex-col justify-between items-center mb-6 md:flex-row">
        ...
        <div class="mt-4 md:mt-0">
            <button wire:click="deleteAll"
                wire:confirm="Are you sure you want to delete all API errors? This action cannot be undone."
        ...
        <table class="w-full text-sm text-left text-neutral-600 dark:text-neutral-400">
            ...
            <tbody class="divide-y divide-neutral-300 dark:divide-neutral-700">
                ...
                <tr class="hover:bg-neutral-100 dark:hover:bg-neutral-800">
                    <td class="p-4">
                        <input type="checkbox" wire:model.live="selectedErrors" value="{{ $error->id }}"
                            class="rounded">
                    </td>
