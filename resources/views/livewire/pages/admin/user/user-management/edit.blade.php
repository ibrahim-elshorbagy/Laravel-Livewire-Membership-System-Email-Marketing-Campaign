            ...
            <form wire:submit.prevent="updateUser" class="p-6 space-y-6">
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <x-text-input wire:model.defer="username" id="username" type="text" class="block w-full mt-1" />
                    ...
                    <div>
                        ...
                        <x-text-input wire:model.defer="company" id="company" type="text" class="block w-full mt-1" />
                    ...
                    <div>
                        ...
                        <x-text-input wire:model.defer="whatsapp" id="whatsapp" type="text" class="block w-full mt-1"  placeholder="+01096325697"/>
                    ...
                    <div>
                        ...
                        <x-text-input wire:model.defer="password" id="password" type="password"
                            class="block w-full mt-1" placeholder="Leave blank to keep current password"
