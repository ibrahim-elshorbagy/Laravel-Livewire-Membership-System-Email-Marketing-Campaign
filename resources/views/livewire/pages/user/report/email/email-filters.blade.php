<div
    ...
    <header class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            ...
            <x-primary-danger-button type="button" wire:confirm="Are you sure you want to delete All Report Emails?"
                wire:click="DeleteAllEmails">
                <span wire:loading.remove wire:target="DeleteAllEmails">Delete Email Filters</span>
            ...
            <x-primary-info-link href="{{ route('user.report.email-bounce') }}" wire:navigate>
                <div class="flex gap-2 justify-center items-center">
                    Back To Email Bounce Report <i class="fa-solid fa-arrow-right"></i>
                </div>
            </x-primary-info-link>
    ...
    <livewire:pages.user.report.email.email-bounce.email-filters-modal>
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center space-x-4">
                ...
                <span class="text-sm font-medium">{{ count($selectedEmails) }} items selected</span>
        ...
        <div class="overflow-x-auto rounded-lg">
            <table class="w-full text-sm text-left text-neutral-600 dark:text-neutral-400">
                <thead
                    class="text-xs uppercase bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100">
                    <tr>
                        <th class="p-4">
                ...
                <tbody class="divide-y divide-neutral-300 dark:divide-neutral-700">
                    ...
                    <tr class="hover:bg-neutral-100 dark:hover:bg-neutral-800">
                        <td class="p-4">
                            <input type="checkbox" wire:model.live="selectedEmails" value="{{ $bounce->id }}"
                                class="rounded">
                        </td>
                        ...
                        <td class="flex gap-3 justify-center p-4">
                            ...
                            <button wire:click="deleteEmail({{ $bounce->id }})"
