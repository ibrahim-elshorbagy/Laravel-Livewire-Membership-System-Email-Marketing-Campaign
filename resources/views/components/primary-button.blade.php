<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex flex-col items-center px-4 py-2
    bg-neutral-600 dark:bg-neutral-900 border rounded-md group border-neutral-300 text-white
    dark:border-neutral-700 dark:text-neutral-300 font-semibold text-xs uppercase tracking-widest hover:bg-gray-700
