<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex flex-col items-center md:px-4 md:py-2 px-2
    py-1 text-nowrap justify-center
    ...
    ease-in-out duration-150 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-green-400
    dark:disabled:bg-green-700
    disabled:hover:bg-green-400 dark:disabled:hover:bg-green-700']) }}>
