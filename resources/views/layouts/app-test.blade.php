...
<body class="font-sans antialiased">
    <div x-data="{ sidebarIsOpen: false }" class="relative flex flex-col w-full md:flex-row">
        ...
        <div class="flex flex-col flex-1 min-h-screen bg-white dark:bg-neutral-950">
                ...
                class="sticky top-0 z-10 flex items-center py-1 border-b justify-evenly border-neutral-300 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900">
                    <div  class="container flex items-center justify-between mx-3 h-14">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            {{-- <span class="text-lg font-bold text-neutral-900 dark:text-white">Site Name</span> --}}
                        </div>
                        <!-- Desktop navigation -->
                        <div class="items-center hidden gap-4 md:flex ">
                            ...
                            {{-- <div x-data="{ isExpanded: false }" class="relative">
                                <button @click="isExpanded = !isExpanded"
                                    class="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-neutral-600 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white">
                                    <i class="fa-solid fa-user"></i>
                                    <span>Productivity</span>
                                    <i class="fa-solid fa-angle-down" :class="isExpanded ? 'rotate-180' : ''"></i>
                                </button>

                                <ul x-show="isExpanded" @click.outside="isExpanded = false"
                                    class="absolute left-0 w-48 mt-2 bg-white border rounded-md shadow-lg dark:bg-neutral-900 dark:border-neutral-700">
                                    <li class="px-2 py-1.5 hover:bg-gray-100 dark:hover:bg-neutral-800">
                                        <x-nav-link href="{{ route('play-ground') }}" wire:navigate>
                                            <i class="fa-solid fa-play fa-spin"></i>
                                            <span>To Do</span>
                                        </x-nav-link>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div x-data="{ userDropdownIsOpen: false }" class="relative">
                                <button @click="userDropdownIsOpen = !userDropdownIsOpen"
                                    class="flex items-center gap-2 p-2 rounded-md hover:bg-black/5 dark:hover:bg-white/5">
                                    <img src="https://penguinui.s3.amazonaws.com/component-assets/avatar-7.webp"
                                        class="object-cover rounded-md size-8" alt="avatar">
            ...
            <!-- Footer -->
            <footer class="py-3 text-center border-t border-neutral-300 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-300">
